...
public class AdvisoryConsumerSample implements MessageListener {
	...
	public void before() throws Exception {
		...
		monitored = session.createQueue("BL.test");
	...
	public static void main(String[] args) {
		AdvisoryConsumerSample example = new AdvisoryConsumerSample();
		System.out.print("\n\n\n");
